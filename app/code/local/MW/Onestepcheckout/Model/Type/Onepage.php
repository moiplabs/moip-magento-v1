<?php 
class MW_Onestepcheckout_Model_Type_Onepage extends Mage_Checkout_Model_Type_Onepage{
 ...
 /**
     ...
     */
    public function saveBilling_without_validate($data, $customerAddressId)
    {
        if (empty($data)) {
